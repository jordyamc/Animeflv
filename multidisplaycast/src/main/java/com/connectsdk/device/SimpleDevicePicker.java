...
public class SimpleDevicePicker implements ConnectableDeviceListener {
    ...
    protected MaterialDialog pairingDialog;
    ...
    protected int getStringId(String key) {
        ...
        int id = this.activity.getResources()
                .getIdentifier(key, "string", activity.getPackageName());
    ...
    protected MaterialDialog createSimplePairingDialog() {
    ...
    protected MaterialDialog createPinPairingDialog() {
        PairingDialog dialog = new PairingDialog(activity, pendingDevice);
