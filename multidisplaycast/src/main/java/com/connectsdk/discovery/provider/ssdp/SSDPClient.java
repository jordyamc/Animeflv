...
public class SSDPClient {
     ...
     */
    public DatagramPacket responseReceive() throws Exception {
     ...
     */
    public DatagramPacket multicastReceive() throws Exception {
        byte[] buf = new byte[1024];
        DatagramPacket dp = new DatagramPacket(buf, buf.length);
    ...
    public boolean isConnected() {
        return datagramSocket != null && multicastSocket != null && datagramSocket.isConnected() && multicastSocket
                .isConnected();
    }
