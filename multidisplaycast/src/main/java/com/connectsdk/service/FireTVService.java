...
public class FireTVService extends DeviceService implements MediaPlayer, MediaControl {
        ...
        try {
            ...
            handleAsyncFutureWithConversion(listener, asyncFuture, new ConvertResult<MediaInfo, MediaPlayerInfo>() {
                ...
                public MediaInfo convert(MediaPlayerInfo data) throws JSONException {
                    ...
                    MediaInfo mediaInfo = new MediaInfo(data.getSource(), metaJson.getString(META_MIME_TYPE), metaJson
                            .getString(META_TITLE), metaJson.getString(META_DESCRIPTION), images);
                    return mediaInfo;
                }
            }, error);
        } catch (Exception e) {
    ...
    public void displayImage(String url, String mimeType, String title, String description, String iconSrc, final LaunchListener listener) {
        setMediaSource(new MediaInfo.Builder(url, mimeType).setTitle(title)
    ...
    private void setMediaSource(MediaInfo mediaInfo, final LaunchListener listener) {
        ...
        handleAsyncFutureWithConversion(listener, asyncFuture, new ConvertResult<MediaLaunchObject, Void>() {
            @Override
