...
public class WebAppSession implements MediaControl, MediaPlayer, PlaylistControl {
     ...
     * WebAppSessionListener.
     *
     * @param listener WebAppSessionListener to be called when messages are received
     *                 from the web app
     */
     ...
     * etc.
     */
    public static interface LaunchListener extends ResponseListener<WebAppSession> {
    }
     ...
     * web app
     */
    public static interface StatusListener extends ResponseListener<WebAppStatus> {
    }
