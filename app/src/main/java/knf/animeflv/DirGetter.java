 ...
 */
public class DirGetter extends AsyncTask<String, String, String> {
    InputStream is;
    String _response;
    callback call;
    TaskType taskType;
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            URL u;
            if (params[0].startsWith(new Parser().getBaseUrl(TaskType.NORMAL, context)) || params[0].startsWith(new Parser().getBaseUrl(TaskType.SECUNDARIA, context)) || params[0].contains("getHtml.php")) {
