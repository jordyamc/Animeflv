...
public class SplashText extends AwesomeSplash {
            ...
            Bypass.runJsoupTest(new Bypass.onTestResult() {
                ...
                public void onResult(boolean needBypass) {
                    if (needBypass) {
                        ...
                        handler.postDelayed(runnable, Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(SplashText.this).getString("bypass_time", "30000")));
                        Bypass.check(SplashText.this, new Bypass.onBypassCheck() {
                            @Override
                        ...
                        BypassHolder.clear(SplashText.this);
                        proceed();
                    }
                }
            });
