 ...
 */
public class AdapterDirPelicula extends RecyclerView.Adapter<AdapterDirPelicula.ViewHolder> {
    ...
    public AdapterDirPelicula(Context context, List<String> titulos, List<String> aid, List<String> aidlinks, String json) {
    ...
    @Override
    public AdapterDirPelicula.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).
                inflate(R.layout.item_anime_fav, parent, false);
        return new AdapterDirPelicula.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(AdapterDirPelicula.ViewHolder holder, final int position) {
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("link", new Parser().getUrlPelicula(j, aids.get(position)));
