...
public class AdapterDirovaNew extends RecyclerView.Adapter<AdapterDirovaNew.ViewHolder> {
    ...
    @Override
    public AdapterDirovaNew.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).
                inflate(R.layout.item_anime_fav, parent, false);
        return new AdapterDirovaNew.ViewHolder(itemView, context);
    }

    @Override
    public void onBindViewHolder(final AdapterDirovaNew.ViewHolder holder, final int position) {
