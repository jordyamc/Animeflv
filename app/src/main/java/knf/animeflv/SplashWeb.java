...
public class SplashWeb extends AwesomeSplash {
            ...
            Bypass.runJsoupTest(new Bypass.onTestResult() {
                ...
                public void onResult(boolean needBypass) {
                    if (needBypass) {
                        ...
                        handler.postDelayed(runnable, Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(SplashWeb.this).getString("bypass_time", "30000")));
                        Bypass.check(SplashWeb.this, new Bypass.onBypassCheck() {
                            @Override
                        ...
                        BypassHolder.clear(SplashWeb.this);
                        proceed();
                    }
                }
            });
