                ...
                if (contrasena.getText().toString().contains(" ")){
                    ...
                    if (!contrasena.getText().toString().equals(rcontrasena.getText().toString())){
                        ...
                        if (!existe) {
                            ...
                            Log.d("favs", fav);
                            new LoginServer(getActivity(), TaskType.NEW_USER, email.getText().toString(), encriytedmailfinal, encriytedpassfinal, null).execute(new Parser().getBaseUrl(TaskType.NORMAL, getActivity()) + "fav-server.php?tipo=nCuenta&email_coded=" + encriytedmailfinal + "&pass_coded=" + encriytedpassfinal + "&fav_code=" + fav + ":;:" + vistos);
                        }else {
            ...
            if (login_contrasena.getText().toString().length()<4){
                ...
                if (login_contrasena.getText().toString().contains(" ")){
                    ...
                    if (existe) {
                        ...
                        Log.d("mail", encriytedmailfinal);
                        Log.d("pass", encriytedpassfinal);
                        new LoginServer(getActivity(), TaskType.GET_FAV, login_email.getText().toString(), encriytedmailfinal, encriytedpassfinal, dialog).execute(new Parser().getBaseUrl(TaskType.NORMAL, getActivity()) + "fav-server.php?tipo=get&email_coded=" + encriytedmailfinal + "&pass_coded=" + encriytedpassfinal);
                    }else {
                        ...
                        if (cPass_ncontrasena.getText().toString().contains(" ")) {
                            ...
                            if (existe) {
                                if (npass.equals(cPass_rncontrasena.getText().toString())) {
                                    ...
                                    Log.d("mail", encriytedmailfinal);
                                    Log.d("pass", encriytedpassfinal);
                                    new LoginServer(getActivity(), TaskType.cPass, null, null, encriytednpassfinal, dialog).execute(new Parser().getBaseUrl(TaskType.NORMAL, getActivity()) + "fav-server.php?tipo=cPass&email_coded=" + encriytedmailfinal + "&pass_coded=" + encriytedpassfinal + "&new_pass_coded=" + encriytednpassfinal);
                                }else {
                ...
                if (cCorreo_contrasena.getText().toString().length() < 4) {
                    ...
                    if (cCorreo_contrasena.getText().toString().contains(" ")) {
                        ...
                        if (existe) {
                            ...
                            Log.d("mail", encriytedmailfinal);
                            Log.d("pass", encriytedpassfinal);
                            new LoginServer(getActivity(), TaskType.cCorreo, cCorreo_nemail.getText().toString(), encriytedmailfinal, null, dialog).execute(new Parser().getBaseUrl(TaskType.NORMAL, getActivity()) + "fav-server.php?tipo=cCuenta&past_email_coded=" + encriytedmailfinal + "&new_email_coded=" + encriytednmailfinal + "&pass_coded=" + encriytedpassfinal);
                        } else {
