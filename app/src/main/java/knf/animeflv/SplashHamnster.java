...
public class SplashHamnster extends AwesomeSplash {
            ...
            Bypass.runJsoupTest(new Bypass.onTestResult() {
                ...
                public void onResult(boolean needBypass) {
                    if (needBypass) {
                        ...
                        handler.postDelayed(runnable, Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(SplashHamnster.this).getString("bypass_time", "30000")));
                        Bypass.check(SplashHamnster.this, new Bypass.onBypassCheck() {
                            @Override
                        ...
                        BypassHolder.clear(SplashHamnster.this);
                        proceed();
                    }
                }
            });
