...
import me.wangyuwei.particleview.LineEvaluator;
import me.wangyuwei.particleview.Particle;

public class CustomParticleView extends View {
    ...
    public CustomParticleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomParticleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setHostTextColor(@ColorInt int color) {
        mHostBgPaint.setColor(color);
    }

    public void setParticleTextColor(@ColorInt int color) {
        mParticleTextPaint.setColor(color);
        mHostTextPaint.setColor(color);
    }
