 ...
 */
public class InfoNewDeep extends AppCompatActivity implements Requests.callback, LoginServer.callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Drawable upArrow = getResources().getDrawable(R.drawable.ic_exit_r);
        ...
        mTracker.setScreenName("Info Deep " + aid);
        mTracker.send(new HitBuilders.ScreenViewBuilder().build());
        Log.d("URL Deep", parser.getInicioUrl(TaskType.NORMAL, context) + "?url=" + parser.getUrlAnimeCached(aid) + "&certificate=" + parser.getCertificateSHA1Fingerprint(context));
