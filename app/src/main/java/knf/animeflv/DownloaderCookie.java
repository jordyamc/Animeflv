 ...
 */
public class DownloaderCookie extends AsyncTask<String, String, String> {
    String eid;
    String aid;
    String titulo;
    String numero;
    ...
    public DownloaderCookie(Context c, String eid, String aid, String titulo, String numero, File ext, CookieConstructor constructor) {
        this.eid = eid;
        this.titulo = titulo;
        this.numero = numero;
        this.aid = aid;
    ...
    protected String doInBackground(final String... params) {
        ...
        try {
            ...
            final DownloadRequest downloadRequest = new DownloadRequest(download)
                    .addCustomHeader("cookie", constructor.getCookie())
                    .addCustomHeader("User-Agent", constructor.getUseAgent())
                    .addCustomHeader("Accept", "text/html, application/xhtml+xml, *" + "/" + "*")
                    .addCustomHeader("Accept-Language", "en-US,en;q=0.7,he;q=0.3")
                    .addCustomHeader("Referer", constructor.getReferer())
